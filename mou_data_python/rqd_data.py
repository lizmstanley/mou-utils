...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o",
        "--outfile-path",
        help="Output file path for the CSV file. Example: python rqd_data.py -d 2026-01-01 -o /some/directory (Process RQD records submitted after January 1, 2026 and output the result csv file to /some/directory)",
        required=False,
        default=None
    )
